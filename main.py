...
class RoadManager:
    def __init__(self, speed):
        ...
        for i in range(2):
            road = arcade.Sprite(os.path.join(ASSETS, "road.png"))
...
class EnemyManager:
    ...
    def spawn_enemy(self, speed):
        enemy = arcade.Sprite(
            os.path.join(ASSETS, "car_enemies.png"),
            scale=0.5,
            angle=90
        )
...
class RaceGame(arcade.Window):
    ...
    def __init__(self):
        ...
        # ------------------ SOUNDS ------------------
        self.engine_sound = arcade.Sound(os.path.join(SOUNDS, "engine_loop.wav"))
        self.pass_sound = arcade.Sound(os.path.join(SOUNDS, "pass.wav"))
        self.crash_sound = arcade.Sound(os.path.join(SOUNDS, "crash.wav"))
        self.achievement_sound = arcade.Sound(os.path.join(SOUNDS, "achievement.wav"))
        self.menu_sound = arcade.Sound(os.path.join(SOUNDS, "menu_click.wav"))
    ...
    def setup(self):
        ...
        self.player = arcade.Sprite(
            os.path.join(ASSETS, "car_allies.png"),
            scale=PLAYER_SCALE,
            angle=-90
        )
